...
3. Run the backend using:
   ...
   python app.py
   ```
4. Access the React dashboard (frontend) if needed.
5. View the results in the web dashboard.

## 🧪 Result
✅ The system detects faces, identifies individuals, and records attendance automatically.

---
## 📜 Full Project Code


### `sih 2/make_attendance_zip.py`
...
### `sih 2/AI_Face_Attendance_Personalized/README.md`
...
### `sih 2/AI_Face_Attendance_Personalized/requirements.txt`
...
### `sih 2/AI_Face_Attendance_Personalized/backend/app.py`
...
### `sih 2/AI_Face_Attendance_Personalized/backend/react_dashboard/package.json`
...
### `sih 2/AI_Face_Attendance_Personalized/backend/react_dashboard/vite.config.js`

```js
export default { root: 'src', server: { port: 5173 } }
```


### `sih 2/AI_Face_Attendance_Personalized/backend/react_dashboard/public/index.html`
...
### `sih 2/AI_Face_Attendance_Personalized/backend/react_dashboard/src/App.jsx`
...
### `sih 2/AI_Face_Attendance_Personalized/backend/react_dashboard/src/index.css`
...
### `sih 2/AI_Face_Attendance_Personalized/backend/react_dashboard/src/main.jsx`
...
### `sih 2/AI_Face_Attendance_Personalized/backend/react_dashboard/src/components/AttendanceUpload.jsx`

```jsx
export default function AttendanceUpload(){return <div>AttendanceUpload</div>}
```


### `sih 2/AI_Face_Attendance_Personalized/backend/react_dashboard/src/components/AttendanceView.jsx`

```jsx
export default function AttendanceView(){return <div>AttendanceView</div>}
```


### `sih 2/AI_Face_Attendance_Personalized/backend/react_dashboard/src/components/ExportButton.jsx`

```jsx
export default function ExportButton(){return <div>ExportButton</div>}
```


### `sih 2/AI_Face_Attendance_Personalized/backend/react_dashboard/src/components/RegisterForm.jsx`
...
### `sih 2/AI_Face_Attendance_Personalized/backend/static/style.css`

```css
body {
  background: radial-gradient(circle at top, #009ffd, #2a2a72);
...
### `sih 2/AI_Face_Attendance_Personalized/backend/templates/index.html`
    ...
    async function startDetection() {
      ...
      setInterval(async () => {
        ...
        if (data.status === "recognized") {
          statusMsg.textContent = `✅ Marked for ${data.name}`;
        } else if (data.status === "unknown") {
          statusMsg.textContent = "❌ Unknown face";
        } else {
